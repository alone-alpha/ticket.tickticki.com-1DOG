...
export default function TicketPage() {
  ...
  const ticket = getTicket(params?.ticketId || "CBW3S7ZG");
  ...
  return (
    <main className="page-shell">
      ...
      <section className="ticket">
        ...
        <img className="hero" src="https://print.tickticki.com/images/kaavish26/ticket_1400px560px.jpg" alt="Event banner" />
        <div className="pass-title">{ticket.passLabel} - {ticket.page} of 4</div>
        ...
        <div className="details-grid">
          <div className="details-column">
            ...
            <div className="person">{ticket.name}<br />{ticket.phone}</div>
          </div>
          <div className="details-column right">
            ...
            <div className="person">{ticket.gateOpens}<br />{ticket.venue}</div>
          </div>
        </div>

        <div className="content-row">
          <div className="terms">
            <p>This entry pass is a sample/demo document for UI testing. It is not an official ticket and does not grant event access.</p>
          ...
          <aside className="qr-panel" aria-label="Demo QR area">
            <div className="qr-wrap"><DemoQr value={`DEMO-TICKET:${ticket.ticketId}`} /></div>
          </aside>
        </div>

        <img className="footer-banner" src="https://print.tickticki.com/images/kaavish26/footer_1400px_100px.jpg" alt="" />
        <div className="partner">Software Development Partner <strong>LILABALI.COM</strong></div>
      </section>
    </main>
  );
}
